...
const AmazonStyleNavbar = () => {
  ...
  // keep navbar input in sync with ?q= if present
  useEffect(() => {
  ...
  const handleSearch = (e) => {
    ...
    if (term !== "") {
      // 🔑 stay on the Products route ("/") and write the query there
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-6 text-sm relative">
            ...
            <div className="relative group">
              <div className="flex items-center gap-1 hover:text-yellow-400 transition cursor-pointer">
                ...
                <ChevronDown size={20} className="ml-1 transition-transform group-hover:rotate-180" />
              </div>
      ...
      <div className="md:hidden w-full">
        <div className="flex items-center bg-gray-800  p-4 justify-between">
          ...
          <div className="flex gap-2">
            <Link to="/">
              <button
                className={`text-sm font-semibold px-3 py-1 rounded-full shadow ${location.pathname === "/" ? "bg-yellow-400 text-black" : "bg-gray-800 text-white border border-white"
                  }`}
              >
                Products
              </button>
            ...
            <Link to="/rental">
              <button
                className={`text-sm font-semibold px-3 py-1 rounded-full shadow ${location.pathname === "/rental" ? "bg-yellow-400 text-black" : "bg-gray-800 text-white border border-white"
                  }`}
              >
                Rental Bay
              </button>
      ...
      {/* Bottom Navbar */}
      <div
        className={`hidden md:flex bg-gray-800 text-white text-[15px] px-8 py-2 fixed top-[65px] z-10 w-full items-center gap-6 shadow transition-transform duration-300 ${showBottomNavbar ? "translate-y-0" : "-translate-y-full"
          }`}
      >
        <span
        ...
        <button
          onClick={() => handleCategoryClick("Lehnga's")}
          className="hover:text-yellow-400 transition"
        >
          Lehnga's
        </button>
        ...
        <div className="ml-auto flex gap-3">
          <Link to="/">
            <button
              className={`font-semibold px-5 py-1.5 rounded-full shadow-md transition ${location.pathname === "/"
          ...
          <Link to="/rental">
            <button
              className={`font-semibold px-5 py-1.5 rounded-full shadow-md transition ${location.pathname === "/rental"
                ? "bg-yellow-400 text-black"
                : "bg-gray-800 text-white border border-white hover:bg-yellow-400 hover:text-black"
                }`}
            >
...
//     <>
//       {/* Main Navbar */}
//       <nav className="bg-white fixed top-0 w-full z-20 text-black px-4 py-3 shadow-md">
//         <div className="hidden md:flex items-center justify-between gap-6 flex-wrap">
//           {/* Logo */}
//           <Link to="/" className="flex items-center group">
//             <span className="text-3xl font-extrabold text-blue-600 group-hover:scale-105 transition-transform duration-300">
//               WishCart
//             </span>
//           </Link>
...
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//               className="flex-grow px-4 py-2 rounded-l-full bg-gray-100 text-black focus:ring-2 focus:ring-blue-400 outline-none shadow-inner"
//               placeholder="Search for products..."
//             />
//             <button
//               type="submit"
//               className="bg-blue-500 px-5 rounded-r-full hover:bg-blue-600 transition"
//             >
//               <FiSearch className="text-white" />
//             </button>
//           </form>

//           <button className="border border-blue-500 rounded-full px-6 py-2 font-semibold hover:bg-blue-500 hover:text-white transition shadow-md">
//             Download App
//           </button>
...
//           <div className="flex items-center gap-6 text-sm relative">
//             {/* Cart */}
//             <Link to="/carts" className="relative hover:text-blue-500 transition">
//               <div className="flex items-center gap-1">
//                 <ShoppingCart size={26} />
//                 <h1 className="text-lg">Cart</h1>
//               </div>
//               {cartCount > 0 && (
//                 <span className="absolute -top-1 -right-2 text-xs bg-blue-500 text-white rounded-full px-1 font-bold animate-bounce">
//                   {cartCount}
//                 </span>
//               )}
//             </Link>
...
//             {/* User Dropdown */}
//             <div className="relative group">
//               <div className="flex items-center gap-1 hover:text-blue-500 transition cursor-pointer">
//                 <User size={26} />
//                 <h1 className="text-lg">Mr Chitranch</h1>
//                 <ChevronDown size={20} className="ml-1 transition-transform group-hover:rotate-180" />
//               </div>
...
//       {/* Bottom Navbar */}
//       <div
//         className={`hidden md:flex bg-gray-100 text-black text-[15px] px-8 py-2 fixed top-[65px] z-10 w-full items-center gap-6 shadow transition-transform duration-300 ${
...
//         <button onClick={() => handleCategoryClick("Home & Kitchen")} className="hover:text-blue-500 transition">
//           Home & Kitchen
//         </button>
//         <button onClick={() => handleCategoryClick("Men's")} className="hover:text-blue-500 transition">
//           Men's
//         </button>
//         <button onClick={() => handleCategoryClick("Women's")} className="hover:text-blue-500 transition">
//           Women's
//         </button>
//         <button onClick={() => handleCategoryClick("Cosmetics")} className="hover:text-blue-500 transition">
//           Cosmetics
//         </button>
//         <button onClick={() => handleCategoryClick("Lehnga's")} className="hover:text-blue-500 transition">
//           Lehnga's
//         </button>
//         <button onClick={() => handleCategoryClick("Shoes")} className="hover:text-blue-500 transition">
//           Shoes
//         </button>
...
//                   : "bg-gray-200 text-black border border-gray-300 hover:bg-blue-500 hover:text-white"
//               }`}
//             >
//               Products
//             </button>
